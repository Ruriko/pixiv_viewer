...
export default {
  ...
  data() {
    return {
      ...
      finished: false,
      menu: {
        daily: { name: "Day", io: "day" },
        weekly: { name: "Week", io: "week" },
        monthly: { name: "Month", io: "month" },
        rookie: { name: "Rookie", io: "week_rookie" },
        original: { name: "Original", io: "week_original" },
        male: { name: "Popular Among Males", io: "day_male" },
        female: { name: "Popular Among Females", io: "day_female" },
        r18: { name: "R-18 - Daily", io: "day_r18", x: true },
        "r18-w": { name: "R-18 - Weekly", io: "week_r18", x: true },
        "r18-m": { name: "R-18 - Popular Among Males", io: "day_male_r18", x: true },
        "r18-f": { name: "R-18 - Popular Among Females", io: "day_female_r18", x: true }
      }
    };
  },
  computed: {
